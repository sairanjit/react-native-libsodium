import { crypto_sign_ed25519_sk_to_curve25519 } from 'react-native-libsodium';
import { isEqualUint8Array } from '../utils/isEqualUint8Array';
import { expect, test } from '../utils/testRunner';

test('crypto_sign_ed25519_sk_to_curve25519', () => {
  const privateKey = new Uint8Array([
    23, 12, 100, 83, 68, 221, 23, 158, 24, 170, 13, 234, 4, 53, 212, 90, 147,
    161, 67, 243, 45, 175, 177, 59, 239, 38, 65,
  ]);
